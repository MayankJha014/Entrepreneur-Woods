...
const Footer = () => {
  ...
  return (
    <div>
      {/* <!-- Footer container --> */}
      <footer class=" text-center bg-gray-950 text-neutral-200 lg:text-left">
        ...
        <div class="mx-6 py-10 text-center md:text-left">
          <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="">
              <img src={home?.navLogo} className="w-36 h-24 mx-4" alt="" />
        ...
        {/* <!--Copyright section--> */}
        <div class=" p-6 text-center bg-gray-950">
