  ...
  return (
    <div>
      <div className="h-[14rem] w-full px-8 pt-4 lg:px-0 bg-white hidden sm:flex gap-3">
        <div
          className=" flex flex-col justify-end py-12 px-4 relative bg-no-repeat bg-cover bg-center bg-gray-400 hover:bg-transparent hover:scale-[1.03] hover:z-10 transition-all duration-700 bg-blend-multiply "
          ...
          <div className="flex h-full gap-3 py-1">
            ...
            >
              ...
              <p className="align-bottom text-lg text-white font-oswald font-bold line-clamp-2 ">
                ...
                deserunt inventore doloribus saepe incidunt sunt magni,
                repellat, impedit sequi perferendis quos! Quod, temporibus
                dolores! Sit distinctio ullam dicta vel tempora amet unde
                dolores dolore optio dolorum animi totam rem, quasi aliquid
                voluptates deleniti blanditiis voluptatibus molestiae. Optio
                expedita fugit error perferendis laboriosam, tempora
                voluptatibus.
              </p>
            </div>
            <div
